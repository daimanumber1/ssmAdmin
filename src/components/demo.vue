            ...
            <el-form :model="nowItem" label-width="80px">
              ...
              <el-form-item label="客户来源" size="medium ">
                <el-select v-model="nowItem.cust_source" placeholder="客户来源" style="width: 500px">
                  <el-option v-for="clientSource in clientSourceList" :label="clientSource.dict_item_name" :value="clientSource.dict_item_name" :key="clientSource.id"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="所属行业">
                <el-select v-model="nowItem.cust_industry" placeholder="所属行业" style="width: 500px">
                  <el-option v-for="industry in industryList" :label="industry.dict_item_name" :value="industry.dict_item_name" :key="industry.id"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="客户级别">
                <el-select v-model="nowItem.cust_level" placeholder="客户级别" style="width: 500px">
                  <el-option v-for="clientLevel in clientLevelList" :label="clientLevel.dict_item_name" :value="clientLevel.dict_item_name" :key="clientLevel.id"></el-option>
                </el-select>
              </el-form-item>
